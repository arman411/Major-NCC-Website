...
(function () {
  ...
  canvas.addEventListener('click', (e) => {
    ...
    const intersects = raycaster.intersectObjects([ring, ring2, disc]);
    if(intersects.length > 0) {
      alert("Govt. Polytechnic Hamirpur NCC Unit\n\n• Established: 1978\n• Cadets: 150+ (Army Wing)\n• Motto: Unity and Discipline\n\nJoin the elite force today!");
      // Spin animation on click
      gsap.to(badge.rotation, {y: badge.rotation.y + Math.PI * 2, duration: 1, ease: "power2.out"});
    }
  });
